...
This project is indexed by GitNexus as **EvoWiki** (304 symbols, 688 relationships, 26 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
